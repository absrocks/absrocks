...
class plots_input:
    ...
    src_dir = '/Volumes/seagate/seagate/tsunami/arnason_et_al/multi-cyl/pent-case/output'  # Location of main source directory
    case_dir = ['nocyl']
    ...
    case_flex = ['rigid/SP2D/four-cyl', 'flex/SP2D/flex-four-5e6',
                 'flex/SP2D/flex-four-1e6']  # , 'flex/SP1.5D/flex-four-5e5']  # 'rigid/SP1.5D/four-cyl',
