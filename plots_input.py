...
class plots_input:
    ...
    src_dir = 'F:/seagate/tsunami/arnason_et_al/multi-cyl/pent-case/output'
    ...
    if flux_plot == 'on':
        ...
        colorpe = ['null', '#6baed6','#3182bd','#08519c']  # ['null', '#fd8d3c', '#74c476', '#6baed6']
        ...
        xloc, xlocin = [11, 10.9, 10.96, 10.98], 10  # 11.1, 11.24, 11.17, 11.17, , 11.25, 11.24, 11.24, 11.24, 11.135]
    tke_plot = 'off'
    depth_plot = 'off'
